...
#define SE_UNKNOWN_0x82             0x82 // SE23 Evo Selection list move
#define SE_UNKNOWN_0x83             0x83 // SE24 Evo Selection confirmed
...
#define SE_UNKNOWN_0xF3             0xF3 // SE111 Duskull leaves, unhit
#define SE_UNKNOWN_0xF4             0xF4 // SE112 Dusclops entry, footsteps
#define SE_UNKNOWN_0xF5             0xF5 // SE113 Dusclops appears
#define SE_UNKNOWN_0xF6             0xF6 // SE114 Dusclops Hit (same as 31, 129, 139, 151)
#define SE_UNKNOWN_0xF7             0xF7 // SE115 Dusclops absorbs ball
#define SE_UNKNOWN_0xF8             0xF8 // SE116 Dusclops launch absorbed ball
...
#define SE_UNKNOWN_0x104            0x104 // SE126 Kecleon tree hit
#define SE_UNKNOWN_0x105            0x105 // SE127 Package falls from tree; Duplicate of 105
#define SE_UNKNOWN_0x106            0x106 // SE128 Scope initiates
...
#define SE_UNKNOWN_0x119            0x119 // SE140 Groudon Step
...
#define SE_UNKNOWN_0x121            0x121 // SE148 Groudon Boulders Land/Hit
#define SE_UNKNOWN_0x122            0x122 // SE149 *Ground duststorm lift*
#define SE_UNKNOWN_0x123            0x123 // SE150 Ball hit Groudon Fire
#define SE_UNKNOWN_0x124            0x124 // No Sound
#define SE_UNKNOWN_0x125            0x125 // No Sound
#define SE_UNKNOWN_0x126            0x126 // SE151 Rayquaza Hit (Same as 31, 114, 129, 139)
#define SE_UNKNOWN_0x127            0x127 // SE152 *Wind noise*
#define SE_UNKNOWN_0x128            0x128 // SE153 *Short stable electric tone* (SE19 has long form)
#define SE_UNKNOWN_0x129            0x129 // SE154 Rayquaza flyby
...
#define SE_UNKNOWN_0x12E            0x12E // SE159 Stage wind for Rayquaza bonus stage.
